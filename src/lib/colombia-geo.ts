...
/** Match user input or AI text to a canonical Colombia city. */
...
/** Parse AI recommendedSegment text for a known city. */
...
/** Base filter for Colombia users in marketing. */
export function colombiaUserFilter(): Prisma.UserWhereInput {
  return { countryCode: 'co' };
}

/** Group cities by region for UI dropdowns. */
...
/** Legacy shape for homepage/map (cities with coords). */
