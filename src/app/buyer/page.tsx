...
import { ShoppingBag, Package, MessageCircle, ArrowRight, Clock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Hero */}
        <Card className="mb-12 bg-gradient-to-br from-orange-600 to-red-600 text-white overflow-hidden">
          <CardContent className="p-16 text-center">
            <ShoppingBag className="h-20 w-20 mx-auto mb-8 opacity-90" />
            <h2 className="text-5xl font-bold mb-6">Encuentra lo que buscas</h2>
            <p className="text-2xl mb-10 max-w-2xl mx-auto opacity-90">
              Profesionales locales confiables en Colombia
            </p>
            <Button asChild size="lg" className="bg-white text-orange-700 hover:bg-gray-100 text-2xl px-16 py-8 rounded-3xl font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Card className="hover:shadow-xl transition-all group">
            <CardContent className="p-10">
              ...
              <p className="text-gray-600 mb-8">Descubre servicios locales</p>
          ...
          <Card className="hover:shadow-xl transition-all group">
            <CardContent className="p-10">
              ...
              <p className="text-gray-600 mb-8">Revisa tus compras activas</p>
          ...
          <Card className="hover:shadow-xl transition-all group">
            <CardContent className="p-10">
              ...
              <h3 className="text-3xl font-semibold mb-3">Mensajes</h3>
              <p className="text-gray-600 mb-8">Chats con vendedores</p>
              <Button asChild variant="outline" className="w-full">
        ...
        <Card>
          <CardContent className="p-10">
            <h2 className="text-3xl font-semibold mb-8">Actividad Reciente</h2>
            <p className="text-gray-500 text-center py-16">
              Tus pedidos y actividad reciente aparecerán aquí
            </p>
          </CardContent>
        </Card>
      </div>
