...
import { BRAND_NAME, BRAND_LOGO_PATH, BRAND_APP_ICON_PATH, BRAND_MARKETING_LOGO_PATH } from '@/lib/brand';
...
export default function AdminSettings() {
  ...
  const loadDefaultFaqs = async () => {
    const defaults = [
      ...
      { question: '¿Puedo vender autos o motos en OigaGIG?', answer: 'Sí. Usa la categoría "Venta de Autos y Vehículos" al crear un gig. Puedes ofrecer el paquete de documentos OigaGIG (contrato de compraventa + checklist de papeles: SOAT, tecnomecánica, impuestos y traspaso) con precio y ciudad del trámite. El comprador lo elige en el checkout; tras el pago ambos lo descargan en el pedido. Son plantillas de apoyo — el traspaso formal se hace ante tránsito / RUNT.', category: 'vendedores' },
      { question: '¿Puedo ofrecer reparación de computadores y electrónica?', answer: 'Sí. Usa la categoría "Reparación de Computadores y Electrónica" al crear un gig. Define tipo de equipo (PC, laptop, celular, TV, consola), tipo de servicio (diagnóstico, hardware, software, limpieza, instalación o recuperación de datos), visita a domicilio y urgencia. Ideal para técnicos y talleres.', category: 'vendedores' },
          ...
          <div className="bg-card border border-border rounded-3xl p-8">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                />
                <p className="text-[10px] text-muted-foreground mt-1">Site path (e.g. {BRAND_APP_ICON_PATH} default, {BRAND_MARKETING_LOGO_PATH} for full wordmark) or HTTPS URL. Local dev paths like /workspaces/... are ignored. Leave empty for defaults.</p>
              </div>
            </div>
          </div>
