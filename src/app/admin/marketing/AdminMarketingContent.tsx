...
export default function AdminMarketingContent() {
  ...
  const runBuyerPurchaseGuideBlast = (d = false) => runBlast('/api/admin/marketing/buyer-purchase-guide-blast', d, '¿Enviar la guía de compra a los compradores que aún no la recibieron?', setBuyerBlastLoading, setBuyerBlastResult);
