...
export default function OrderDetailPage() {
  ...
  if (!order) return <div className="p-20 text-center text-2xl">Pedido no encontrado</div>;
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="grid gap-6">
        ...
        {/* Progress */}
        <div className="bg-white border rounded-3xl p-8">
          <p className="font-medium mb-4">Progreso del Pedido</p>
        ...
        <div className="bg-white border rounded-3xl p-8">
          ...
          <div className="h-96 bg-gray-50 rounded-2xl border flex items-center justify-center">
            <p className="text-gray-500">Chat persistente con el vendedor (próximamente)</p>
          </div>
        </div>
      </div>
    </div>
