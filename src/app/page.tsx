      ...
      <section className="relative py-20 bg-gradient-to-br from-yellow-400 via-orange-500 to-red-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            {role === "buyer" && <Button size="lg" asChild><Link href="/gigs">Explorar Gigs</Link></Button>}
            {role === "seller" && <Button size="lg" asChild><Link href="/seller">Ir a Mi Dashboard</Link></Button>}
            <Button size="lg" variant="secondary" asChild><Link href="/gigs">Ver Todos los Gigs</Link></Button>
          </div>
        </div>
      </section>
