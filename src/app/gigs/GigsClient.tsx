            ...
            <div className="relative">
              ...
              >
                <button
                  onClick={() => setSelectedCategory("Todas")}
                  className={cn(
                    "snap-start flex-shrink-0 w-[128px] md:w-[140px] flex flex-col items-center justify-center px-2 py-2.5 rounded-2xl border transition-all duration-200 active:scale-[0.985]",
                    selectedCategory === "Todas"
                ...
                {(catLoading ? [] : categoryList).map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "snap-start flex-shrink-0 w-[128px] md:w-[140px] flex flex-col items-center justify-center px-2 py-2.5 rounded-2xl transition-all duration-200 active:scale-[0.985]",
                        isActive
                          ? "border-[3px] border-emerald-500 bg-emerald-50 text-emerald-950 shadow-md outline outline-2 outline-emerald-300/90 outline-offset-0"
                          : "border-[3px] border-transparent bg-white/95 text-slate-800 shadow-sm ring-1 ring-white/40 hover:bg-white hover:shadow-md hover:-translate-y-0.5 dark:bg-white/90 dark:text-slate-900",
                      )}
                    ...
                    >
                      ...
                      <div className="text-[11px] font-medium text-center leading-tight line-clamp-3 break-words">
                        {cat}
                      </div>
                      <div
                        className={cn(
