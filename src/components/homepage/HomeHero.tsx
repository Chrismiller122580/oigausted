...
export function HomeHero() {
  return (
    ...
    >
      {/* Colombian photo collage background */}
      <div className="absolute inset-0 grid grid-cols-4 grid-rows-2 gap-0.5 opacity-40 dark:opacity-30" aria-hidden>
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 py-16 sm:py-20 md:py-24 text-center">
        ...
        <motion.div
          ...
          className="mx-auto max-w-2xl mb-8 rounded-2xl bg-white/10 backdrop-blur-md p-3 sm:p-4 border border-white/20 shadow-2xl"
        >
        ...
        >
          <Button
            asChild
            size="lg"
            className="bg-[#F97316] hover:bg-[#EA580C] text-white font-semibold h-12 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all"
          >
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-4 sm:gap-6 text-sm text-white/90"
          role="list"
