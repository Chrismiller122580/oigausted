            ...
            <div className="flex items-center gap-4">
              {session?.user && (
                <div className="hidden md:flex items-center gap-3">
                  ...
                  <div className="w-9 h-9 bg-orange-100 rounded-full flex items-center justify-center text-2xl">👤</div>
                </div>
              )}

              <Button onClick={() => signOut({ callbackUrl: '/' })} variant="ghost" className="flex items-center gap-2 text-red-600 hover:bg-red-50">
